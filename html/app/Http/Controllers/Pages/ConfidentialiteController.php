...
class ConfidentialiteController extends Controller
{
    public function __invoke()
    {
        ...
        $data = [
            "meta" => [
                "title" => "Chasseur Immobilier Ancien et Neuf à Paris et en Ile de France | Résidence et Investissement locatif | La Fabrique à Toits | Confidentiale",
                "robots" => "index, follow",
        ...
        return view('pages.confidentialite', compact('data'));
    }
}
