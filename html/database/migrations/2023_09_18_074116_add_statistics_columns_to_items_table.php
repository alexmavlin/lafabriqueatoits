...
class AddStatisticsColumnsToItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('items', function (Blueprint $table) {
            ...
            $table->text('statistics_h3_5')->nullable();
            ...
            $table->text('statistics_p_5')->nullable();
        });
    }
    ...
    public function down()
    {
        Schema::table('items', function (Blueprint $table) {
            ...
            $table->dropColumn('statistics_h3_5');
            ...
            $table->dropColumn('statistics_p_5');
        });
    }
}
