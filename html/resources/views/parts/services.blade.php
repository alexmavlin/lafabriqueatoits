<section class="question__cards">
    <h1 class="section__h2--red" style="font-family:'Times New Roman',serif;"  style="color: #e3546d;font-size: 26px;font-weight: 500;font-family: Playfair Display,Times New Roman,serif;margin-bottom: 15px;max-width: 597px;width: 100%;">Notre service de Chasse Immobilière à Paris et en Ile de France</h1>
    <p class="section__description">Que comprend notre service de chasseur immobilier ?</p>
    <div class="container">
        <div class="question__cards--inner">
            ...
            <div class="question__cards--card">
                <div class="question__cards--card__header">
                    ...
                    <h3 class="question__cards--card__heading">Rapport Stratégique</h3>
                </div>
            ...
            <div class="question__cards--card">
                <div class="question__cards--card__header">
                    ...
                    <h3 class="question__cards--card__heading">Financement</h3>
                </div>
            ...
            <div class="question__cards--card">
                <div class="question__cards--card__header">
                    ...
                    <h3 class="question__cards--card__heading">Prospection immobilière & Visites</h3>
                </div>
            ...
            <div class="question__cards--card">
                <div class="question__cards--card__header">
                    ...
                    <h3 class="question__cards--card__heading">Offre d’achat et Compromis</h3>
                </div>
            ...
            <div class="question__cards--card">
                <div class="question__cards--card__header">
                    ...
                    <h3 class="question__cards--card__heading">Décryptage des Diagnostics</h3>
                </div>
            ...
            <div class="question__cards--card">
                <div class="question__cards--card__header">
                    ...
                    <h3 class="question__cards--card__heading">Visite Technique de votre Bien</h3>
                </div>
            ...
            <div class="question__cards--card">
                <div class="question__cards--card__header">
                    ...
                    <h3 class="question__cards--card__heading">Signatures Notaires</h3>
                </div>
            ...
            <div class="question__cards--card">
                <div class="question__cards--card__header">
                    ...
                    <h3 class="question__cards--card__heading">Démarches Administratives</h3>
                </div>
            ...
            <div class="question__cards--card">
                <div class="question__cards--card__header">
                    ...
                    <h3 class="question__cards--card__heading">Aide pour les Travaux</h3>
                </div>
