<section class="offer">
    <div class="container">
        <div class="offer__inner">
            <div class="offer__logo__container">
              <svg class="offer__logo" xmlns="http://www.w3.org/2000/svg" width="950" height="997" viewBox="0 0 950 997" fill="none">
            ...
            <div class="offer__row">
                ...
                <div class="offer__right">
                    <img    srcset="{{ asset('images/content/' . $data['content']['offer_img_2']) }} 1920w,
                            ...
                            class="offer__right__img">
                    {!! $data['content']['offer_h2_2'] !!}
                    {!! $data['content']['offer_p_2'] !!}
                </div>
            </div>
            <div class="offer__row">
                <div class="offer__left__second">
            ...
            <div class="offer__row">
                <div class="offer__left__third">
                    <img    srcset="{{ asset('images/content/' . $data['content']['offer_img_5']) }} 1920w,
                                    {{ asset('images/content/' . $data['content']['offer_img_5_600']) }} 700w,
                                    {{ asset('images/content/' . $data['content']['offer_img_5_400']) }} 500w"
                            src="{{ asset('images/content/' . $data['content']['offer_img_1']) }}" 
                            width="750"
                            height="820"
                            alt="{{ $data['content']['offer_img_alt_5'] }}"
                            title="{{ $data['content']['offer_img_alt_5'] }}" 
                            class="offer__left__img">
                    {!! $data['content']['offer_h2_5'] !!}
                    {!! $data['content']['offer_p_5'] !!}
                </div>
            </div>
        </div>
    </div>
