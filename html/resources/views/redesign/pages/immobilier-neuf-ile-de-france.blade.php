                    ...
                    <div class="searchForm__sidebar--wrapper" id="earchForm__sidebar--wrapper">
                        ...
                        <div class="searchForm__formGroup">
                            ...
                            <div class="searchForm__select--wrapper">
                                <select type="text" class="searchForm__select">
                        ...
                        <div class="searchForm__formRow">
                            ...
                            <div class="searchForm__rangeGroup" id="searchForm__rangeGroup">
                                ...
                                <input class="range-min" type="range" min="0" max="1999990" step="10" value="100000">
                                <input class="range-max" type="range" min="10" max="2000000" step="10" value="2000000">
                        ...
                        <div class="searchForm__btnGroup" id="searchForm__btnGroup">
                            <a href="#" class="searchForm__submit--btn">rechercher</a>
                ...
                <div class="searchForm__content">
                    <div class="searchForm__top" id="searchForm__top">
                        ...
                        <div class="searchForm__formGroup">
                            <div class="searchForm__select--wrapper">
                                <select type="text" class="searchForm__select">
                                    <option value="" selected>Prix Croissant</option>
                    ...
                    <div class="searchForm__widget row" id="searchForm__widget">
                        <a href="#" class="searchForm__item">
                            <div class="searchForm__item--top">
                                <img    src="images/content/housing_item_img.png" 
                                        alt=""
                                        width="340"
                                        height="340"
                                        class="searchForm__item--img">
                                <div class="searchForm__item--tags">
                                    <div class="searchForm__item--tag">Appartement</div>
                                    <div class="searchForm__item--tag">PINEL</div>
                                    <div class="searchForm__item--tag">1ER TRI 2023</div>
                                </div>
                            </div>
                            <div class="searchForm__item--content">
                                ...
                                <p class="searchForm__item--p">Découvrez des stratégies d'experts pour transformer votre propriété en une location rentable. De techniques marketing à la gestion des locataires, explorez des conseils complets adaptés pour les propriétaires.</p>
